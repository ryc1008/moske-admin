...
Route::post('/auth', 'LoginController@index');//登录
...
Route::group(['middleware' => ['auth:admin']], function () {
    ...
    Route::group(['prefix' => 'falling'], function () {
        Route::get('/', 'FallingController@list')->name('admin.falling.list');
        Route::get('/config', 'FallingController@config')->name('admin.falling.config');
    });
