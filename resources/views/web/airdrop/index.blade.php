...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="app">
{{--            http://175.27.250.69:85/h5GameNew?t={{$time}}   http://localhost:7456/--}}
            <iframe src="http://175.27.250.69:85/h5GameNew?t={{$time}}"  width="100%" height="100%" class="myiframe" id="game"></iframe>
        </div>
    </body>
    <script>
