<template>
    <div class="page">
            ...
            <div class="form">
                ...
                <el-form ref="form" :rules="rules" :model="form" status-icon>
                    <el-form-item prop="username">
                        <el-input v-model="form.username" placeholder="请填写渠道账号" autocomplete="off"
                                  prefix-icon="fa fa-user"></el-input>
                    </el-form-item>
                    <el-form-item prop="password">
                        <el-input v-model="form.password" placeholder="请填写渠道密码" autocomplete="new-password"
        ...
        <div class="copyright">
            Copyright © Powered By Canal System {{ year }}
        </div>
    </div>
</template>

<script>
import {LoginSubmit} from '@/request/agent.js';
