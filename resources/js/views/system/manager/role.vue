    ...
    <div class="board-content">
        ...
        <div class="board-main">
            <el-table v-if="datas" element-loading-text="努力加载中..."
                ...
                <el-table-column prop="remark" label="描述" width="350"></el-table-column>
            ...
            <el-form v-if="form" :model="form" :rules="rules" ref="form" class="board-form" label-width="120px">
                ...
                <div class="form-item">
                    <el-form-item label="名 称：" prop="title">
                        <el-input v-model="form.title" placeholder="请填写角色名称" prefix-icon="fa fa-bars" size="medium" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="描 述：" prop="remark">
                        <el-input v-model="form.remark" placeholder="请填写角色描述" prefix-icon="fa fa-file-text-o" size="medium" clearable></el-input>
                    </el-form-item>
                </div>
            </el-form>
...
import {RoleList, RoleUpdate, RoleDestroy} from '@/request/system.js';
...
export default {
    ...
    methods: {
        ...
        async access(id) {
            ...
            this.$router.push({name: 'admin_access', query: {id: id}});
        },
        search() {
            this.params.page = 1;
            this.list();
