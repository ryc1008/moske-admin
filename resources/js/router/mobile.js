...
const Login = () => import('@/views/agent/auth/login.vue');
const Layout = () => import('@/views/layout/layout.vue');
const Main = () => import('@/views/main/login.vue');
...
const Config = () => import('@/views/system/login.vue');
const User = () => import('@/views/user/login.vue');
const Falling = () => import('@/views/user/falling.vue');
...
export const asyncRouterMap = [
    {path: '/config', component: Layout, meta: {title: '系统管理', icon: 'fa fa-cog'}, children: [
        ...
        {path: '/falling', name: 'falling', component: Falling, meta: {title: '掉落日志', show: true, auth: 'falling.list'}},
    ]},
    {path: '/manager', component: Layout, meta: {title: '权限管理', icon: 'fa fa-gavel'}, children: [
        ...
        {path: '/log', name: 'log', component: Log, meta: {title: '登录日志', show: true, auth: 'auth.list'}}
    ]},
    {path: '*', redirect: '/error'}
];

const router = new VueRouter({
    mode: 'history', base: '/mobile', routes: constantRouterMap
});
