            ...
            <el-table v-if="datas" element-loading-text="努力加载中..."
                ...
                <el-table-column prop="thumb" label="头像" width="70" align="center">
                    <template slot-scope="scope">
                        <el-image class="board-table-image" :src="'/image/' + scope.row.avatar + '.jpg'" :preview-src-list="['/image/' + scope.row.avatar + '.jpg']"></el-image>
                    </template>
                </el-table-column>
                ...
                <div class="board-form-item">
                    ...
                    <el-form-item label="头 像：" prop="avatar">
                        <div class="form-avatar">
                            <img v-for="(avatar,a) in avatars" :src="'/image/'+ avatar +'.jpg'"
