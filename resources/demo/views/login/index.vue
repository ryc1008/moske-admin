<template>
    <div class="page">
        <div class="login">
            <div class="login-bg">
<!--                <img src="/image/login-bg.jpg" s alt="">-->
            </div>
            <div class="form">
                <div class="title"><span>登 录</span> | <span class="py">Login</span></div>
                <el-form ref="form" :rules="rules" :model="form" status-icon>
                    <el-form-item prop="username">
                        <el-input v-model="form.username" placeholder="请填写管理员账号" autocomplete="off" prefix-icon="fa fa-user"></el-input>
                    </el-form-item>
                    <el-form-item prop="password">
                        <el-input v-model="form.password" placeholder="请填写管理员密码" autocomplete="new-password" prefix-icon="fa fa-lock"
                    ...
                    <div class="copyright">
                        Copyright © Powered By Admin System 2023
                    </div>
                </el-form>
            </div>
        </div>
...
.login .form .title span{
    position: relative; top:3px; font-size: 34px;
}
